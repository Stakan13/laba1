...
def main():
    ...
    while True:
        ...
        if choice == 1:
            ...
            OperationJSON.add_car(OperationJSON.load_json("result.json"), car)
            ...
            OperationJSON.add_car(OperationJSON.load_json("result.json"), truck)
            ...
            OperationJSON.add_car(OperationJSON.load_json("result.json"), submarine)
            ...
            OperationJSON.add_car(OperationJSON.load_json("result.json"), bus)
            ...
            OperationJSON.add_car(OperationJSON.load_json("result.json"), heli)
            ...
            OperationJSON.add_car(OperationJSON.load_json("result.json"), plane)
